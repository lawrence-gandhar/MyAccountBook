...
AddressFormset = inlineformset_factory(contacts_model.Contacts, users_model.User_Address_Details, extra = 1,
    ...
    widgets = {
        ...
        'is_billing_address' : Select(attrs={'class':'form-control input-sm',}, choices = user_constants.IS_TRUE, ),
        'is_shipping_address' : Select(attrs={'class':'form-control input-sm',}, choices = user_constants.IS_TRUE, ),
    }
)
