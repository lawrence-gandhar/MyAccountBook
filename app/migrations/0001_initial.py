    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_imported_user', models.BooleanField(choices=[(True, 'YES'), (False, 'NO')], db_index=True, default=False)),
                ...
                ('imported_user', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='imported_user', to=settings.AUTH_USER_MODEL)),
